...
// const sellerAddress = '7qoZLLYAY16Ly3s9wy6tsx8r5E8ojUWYDuf7F71KfBPS'
...
const createTransaction = async (req, res) => {
  try {
    ...
    const sellerKey = products.find((item) => item.id === itemID).sellerKey;
    const sellerPublicKey = new PublicKey(sellerKey);
